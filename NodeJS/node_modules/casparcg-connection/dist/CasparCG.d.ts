...
export declare class CasparCG extends EventEmitter implements ICasparCGConnection, ConnectionOptions, CasparCGProtocols.v2_1.AMCP {
  ...
  * con.connect();
    ...
    */
     ...
     */
    loadbg(channel: number, layer: number, clip: string): Promise<IAMCPCommand>;
    ...
    loadbg(channel: number, layer: number, clip: string, loop?: boolean, transition?: string, transitionMaskFile?: string, transitionStingDuration?: number, transitionOverlay?: string, seek?: number, length?: number, filter?: string, auto?: boolean | number | string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOADBG>
     */
    loadbgAuto(channel: number, layer: number, clip: string): Promise<IAMCPCommand>;
    loadbgAuto(channel: number, layer: number, clip: string, loop?: boolean, transition?: Enum.Transition, transitionDuration?: number, transitionEasing?: Enum.Ease | string, transitionDirection?: Enum.Direction | string, seek?: number, length?: number, filter?: string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    loadbgAuto(channel: number, layer: number, clip: string, loop?: boolean, transition?: string, transitionMaskFile?: string, transitionStingDuration?: number, transitionOverlay?: string, seek?: number, length?: number, filter?: string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOAD>
     */
    load(channel: number, layer: number, clip: string): Promise<IAMCPCommand>;
    load(channel: number, layer: number, clip: string, loop?: boolean, transition?: Enum.Transition, transitionDuration?: number, transitionEasing?: Enum.Ease | string, transitionDirection?: Enum.Direction | string, seek?: number, length?: number, filter?: string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    load(channel: number, layer: number, clip: string, loop?: boolean, transition?: string, transitionMaskFile?: string, transitionStingDuration?: number, transitionOverlay?: string, seek?: number, length?: number, filter?: string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#PLAY>
     */
    play(channel: number, layer?: number): Promise<IAMCPCommand>;
    play(channel: number, layer: number, clip: string): Promise<IAMCPCommand>;
    play(channel: number, layer: number, clip: string, loop?: boolean, transition?: Enum.Transition, transitionDuration?: number, transitionEasing?: Enum.Ease | string, transitionDirection?: Enum.Direction | string, seek?: number, length?: number, filter?: string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    play(channel: number, layer: number, clip: string, loop?: boolean, transition?: string, transitionMaskFile?: string, transitionStingDuration?: number, transitionOverlay?: string, seek?: number, length?: number, filter?: string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOADBG>
     */
    loadDecklinkBg(channel: number, layer: number | undefined, device: number, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string, auto?: boolean | number | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOADBG>
     */
    loadDecklinkBgAuto(channel: number, layer: number | undefined, device: number, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
     ...
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOAD>
     */
    loadDecklink(channel: number, layer: number | undefined, device: number, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#PLAY>
     */
     ...
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOADBG>
     */
    loadRouteBg(channel: number, layer: number | undefined, route: string | {
        channel: number;
        layer?: number;
    }, mode: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string, auto?: boolean | number | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOADBG>
     */
    loadRouteBgAuto(channel: number, layer: number | undefined, route: string | {
        channel: number;
        layer?: number;
    }, mode: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOAD>
     */
    loadRoute(channel: number, layer: number | undefined, route: string | {
        channel: number;
        layer?: number;
    }, mode: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#PLAY>
     */
    playRoute(channel: number, layer: number | undefined, route: string | {
        channel: number;
        layer?: number;
    }, mode: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, length?: number, filter?: string, format?: Enum.ChannelFormat | string, channelLayout?: Enum.ChannelLayout | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOADBG>
     */
    loadHtmlPageBg(channel: number, layer: number | undefined, clip: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string, auto?: boolean | number | string): Promise<IAMCPCommand>;
    /**
     *
     */
    loadHtmlPageBgAuto(channel: number, layer: number | undefined, url: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOAD>
     */
    loadHtmlPage(channel: number, layer: number | undefined, url: string, transition?: Enum.Transition | string, transitionDurationOrMaskFile?: number | string, transitionEasingOrStingDuration?: Enum.Ease | string | number, transitionDirectionOrOverlay?: Enum.Direction | string): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#PLAY>
     */
    ...
    playHtmlPage(channel: number, layer: number, url?: string, transition?: Enum.Transition | string, transitionMaskFile?: string, transitionStingDuration?: number, transitionOverlay?: Enum.Direction | string): Promise<IAMCPCommand>;
    /**
     ...
     */
    mixerBlend(channel: number, layer: number, blendmode: string | Enum.BlendMode, defer?: boolean): Promise<IAMCPCommand>;
    mixerBlend(channel: number, layer?: number, blendmode?: Enum.BlendMode | string, defer?: boolean): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#MIXER-BLEND>
     */
    mixerBlendDeferred(channel: number, layer: number, blendmode: string | Enum.BlendMode): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#MIXER-BLEND>
     */
    getMixerStatusBlend(channel: number, layer?: number): Promise<IAMCPCommand>;
     ...
     */
    mixerOpacity(channel: number, layer: number, opacity: number, transitionDuration?: number, transitionEasing?: string | Enum.Ease, defer?: boolean): Promise<IAMCPCommand>;
    mixerOpacity(channel: number, layer?: number, opacity?: number, transitionDuration?: number, transitionEasing?: Enum.Ease | string, defer?: boolean): Promise<IAMCPCommand>;
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#MIXER-OPACITY>
     */
     ...
     */
    logLevel(enumOrString: Enum.LogLevel | string): Promise<IAMCPCommand>;
    /**
     ...
     */
    helpConsumer(consumerOrName?: (Enum.Consumer | string)): Promise<IAMCPCommand>;
    /**
     ...
     * Undocumented, but implemented by Julusian.
     */
    time(channel: number, timecode?: string): Promise<IAMCPCommand>;
    /**
     ...
     */
    private _createTransitionOptionsObject;
    /**
     *
     */
    private _createNewSocket;
    /**
     *
     */
